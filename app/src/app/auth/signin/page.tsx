...
// SIGN IN PAGE
// =============================================================================
// Custom sign-in page for NextAuth with provider buttons
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Automated design QA and visual regression testing
          </p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          ...
          {/* TODO: Add more providers when configured */}
          {/* <button
            onClick={() => signIn('bitbucket', { callbackUrl })}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition-colors"
          >
            <span className="font-medium text-gray-700">Continue with Bitbucket</span>
          </button> */}
        </div>
